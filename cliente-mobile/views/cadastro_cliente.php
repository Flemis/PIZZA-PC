...
<?php if(!isset($_GET['editar'] )) { 
	?>
	<form id="containermenu" autocomplete="off" method="post" action="processa_cliente.php" style="text-align: center;height: 350px;">
...
<?php 
		if(isset($_GET['falha'])) { ?>
			...
			<?php echo '<label style="color:white">'.'EMAIL JA UTILIZADO!'.'</label><br>'; ?>
			</div>
		<?php } ?>
<?php } else { ?>
